---
title: "Praktikum 2 Anreg - Andhias"
...
```{r}
plot(data$X3, data$Y,
     main = "Persentase Penduduk Miskin",
     xlab = "Persentase Penduduk Miskin",
     ylab = "IPM")
```
...
Nilai $\hat\beta_1 = - 0.9377205$ artinya nilai dugaan perubahan dugaan rataan Indeks Pembangunan Manusia jika persentase penduduk miskin berubah satu tahun adalah sebesar - 93,77%

Koefisien determinasi yang dihasilkan adalah 0.4787224 atau 47,87% artinya keragaman persentase penduduk miskin yang dapat dijelaskan oleh persentase indeks pembangunan manusia adalah sebesar 47,87%, sisanya ydijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
